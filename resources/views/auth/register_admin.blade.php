                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="card-content p-3">
                                    ...
                                    <div class="card-title text-uppercase text-center py-3">Criar Conta - ADMIN</div>
                                    <form  method="POST" action="{{ route('/admin/register') }}">
                                        ...
                                        <p class="text-dark">Ja tem uma conta? <a href="{{ route('/admin/login') }}"> Iniciar Seccao</a></p>
